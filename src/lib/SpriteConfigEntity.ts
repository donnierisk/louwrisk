export const spriteConfig: ISpriteConfig = {
    ...
    entities: {
        player: {
            ...
            sourceBlock: { x: 0, y: 0 },
            animations: {
                walkDown: [{ x: 0, y: 1 }, { x: 0, y: 0 }, { x: 0, y: 2 }, { x: 0, y: 0 }],
                walkLeft: [{ x: 2, y: 4 }, { x: 3, y: 3 }, { x: 3, y: 4 }, { x: 3, y: 3 }],
                walkRight: [{ x: 3, y: 1 }, { x: 3, y: 0 }, { x: 3, y: 2 }, { x: 3, y: 0 }],
                walkUp: [{ x: 2, y: 1 }, { x: 2, y: 0 }, { x: 2, y: 2 }, { x: 2, y: 0 }]
            }
        },
        crate1: {
            pos: { x: -1, y: 0 },
